    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 w-full overflow-hidden' id='Projects'>
        ...
        <div className='flex justify-end items-center mb-8'>
            <button onClick={prevProject}
             className='hover:bg-gray-300 p-3 bg-gray-200 rounded mr-2' aria-label='previous project'>
                <img src={assets.left_arrow} alt="previous" />
            </button>
            <button onClick={nextProject}
            className='hover:bg-gray-300 p-3 bg-gray-200 rounded mr-2' aria-label='next project'>
